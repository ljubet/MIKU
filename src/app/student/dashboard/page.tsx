...
export default function DashboardPage() {
  ...
  return (
    <div className="-mx-8 -my-8 h-screen px-6 py-5 bg-gray-50 flex flex-col">
      ...
      <div className="flex gap-4 flex-1 min-h-0">
        ...
        {/* RIGHT: Detail panel */}
        {selectedJob ? (
          <div className="w-[62%] bg-white border border-gray-200 rounded-2xl flex flex-col min-h-0">
          ...
          <div className="w-[62%] bg-white border border-gray-200 rounded-2xl flex items-center justify-center">
